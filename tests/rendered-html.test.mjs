...
test("ships PWA and custom UK map configuration", async () => {
  ...
  assert.match(mapEngine, /const APP_VERSION = "v2\.5\.1"/);
  assert.match(serviceWorker, /map-engine-shell-v1176/);
  ...
  assert.match(routeGraph, /14_000/);
