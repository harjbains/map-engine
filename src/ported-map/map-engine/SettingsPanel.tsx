...
type SettingsPanelProps = {
  ...
  onToggle: (key: "darkMode" | "showSpeed" | "showBuildings" | "showDriverAmenities" | "showLandmarks" | "showPickups", value: boolean) => void;
      ...
      <aside className="settings-panel" aria-label="Map settings">
        ...
        <div className="settings-scroll">
          ...
          <section className="settings-group">
            ...
            {settings.liveTraffic && !trafficConfigured && <p className="settings-note traffic-setup-note">Live traffic is ready for a Mapbox connection. Add the traffic service key to activate it.</p>}
            ...
            <p className="settings-note">Landmarks ahead lists up to three recognised roadside places — petrol stations, supermarkets, pubs, hotels and large stores — inside the 45° view in front of you while driving.</p>
          </section>
        ...
        <footer>OpenFreeMap · OpenMapTiles · OpenStreetMap · Traffic © Mapbox</footer>
      </aside>
    </>
  );
}
