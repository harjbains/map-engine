...
function IncidentSection() {
  return (
    <section className="legend-section" aria-label="Traffic incident markers">
      ...
      <p className="legend-note">“Road closed (live)” is a Mapbox live incident. “Road closure (OSM)” in the safety section is a mapped/planned closure from OpenStreetMap.</p>
    </section>
  );
}
